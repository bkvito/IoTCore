...
*/
		...
		$('button.cesium-home-button').last().after('<button id="measureLength" title="测距" class="cesium-button cesium-toolbar-button"></button>\
													...
													<button id="btn360" title="360度环视分析" class="cesium-button cesium-toolbar-button"></button><button title="地图清除" id="clearTool" class="cesium-button cesium-toolbar-button"></button>');
