/**
 * Created by niuyl on 2019/4/28.
 */
function ztreeCtroller()
{
    //控制按钮
    if($('#modelTreeBox').css('display') == "block")
    {
        $('#modelTreeBox').css('display','none');
    }else{
        $('#modelTreeBox').css('display','block');
    }
    //zTree浮动控制
...
function moveBind(obj, evnt) {
    ...
    //鼠标选中的元素设置成顶层。
    obj.style.zIndex = getMaxIndex() + 100;
